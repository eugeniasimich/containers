...
A las funciones de etiquetado suele designárseles los nombres de {\it inyecciones}, el nombre \AgdaInductiveConstructor{inj} proviene del vocablo inglés {\it injection}. Se las denomina de esa manera porque se considera que inyectan en el objeto coproducto la información de los factores.
