...
Con el fin principal de evitar la reescritura de código, el paradigma conocido como {\it programación genérica} se dedica a la construcción de programas definidos de forma abstracta sobre un conjunto de tipos de datos. Es decir, en lugar de escribir algoritmos que trabajen sobre una estructura en particular, se definen sobre un conjunto amplio de tipos de datos.
